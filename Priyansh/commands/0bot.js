...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "inbox") || (event.body.toLowerCase() == "ib")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "admin")) {
     return api.sendMessage("༻𝐎𝐖𝐍𝐄𝐑:- ☞ ༻☞[𝐎𝐖𝐍𝐄𝐑:☞➸⃝🐼⃝⃞⃟𝐇𝐚𝐦𝐳𝐚 𝐀𝐥𝐢🎸  ☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐇𝐨𝐧𝐞𝐲. ☜ ༺༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- https://www.facebook.com/profile.php?id=100016828397863☞    his insta id @Shankhank345 ☜ ༺༒ ༒", threadID);
   };
...
if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "🫣")) {
     return api.sendMessage("𝐈𝐒 𝐍𝐀𝐙𝐀𝐑 𝐒𝐈𝐑𝐀𝐅 𝐌𝐔𝐉𝐇𝐄 ذینـﹻﹿٰٰٰٖٖٖٜ۬ﹿٰٰٖٖٜ ﹻ۬ﹻۧۛﹻ۬ﹻﹿـی 𝐃𝐄𝐊𝐇 𝐒𝐀𝐊 𝐓𝐇𝐈 𝐇𝐀𝐈", threadID);
   };
